# Технические интервью на позицию системного архитектора или senior web developer

## Архитектура систем и проектирование
### Паттерны проектирования
- [Создающие паттерны](Создающие_паттерны.md)
- [Структурные паттерны](Структурные_паттерны.md)
- [Поведенческие паттерны](Поведенческие_паттерны.md)
- [Конкурентные паттерны](Конкурентные_паттерны.md)
- [Архитектурные паттерны](Архитектурные_паттерны.md)
